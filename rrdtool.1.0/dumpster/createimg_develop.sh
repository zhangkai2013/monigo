...
## 图标x轴横栏标题
comment_io_rws="COMMENT:磁盘读写次数-------Maximum---------Average----------last"
comment_io_rwn="COMMENT:磁盘读写量---------------Maximum---------Average----------last"
comment_upload="COMMENT:系统负载----------Current"
comment_traffic="COMMENT:接口流量-------Maximum----------Average---------last"
...
comment_cache_buffer="COMMENT:CacheBuffers统计------Maximum-------------Average--------------last"
